...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "saOH3dLVo6quTYYcddTJBgCIN8dvv1aCNizRAu_w";
    private static final String SECRETKEY = "lhbJb_MG8oI5_LOi6mWe9G0CHiCVFtFHS6XSYMRF";
    private static final String BUCKET = "health";
    public static final String DOMAIN= "http://pv3kpa3v6.bkt.clouddn.com";

    public static void main(String[] args) {
        uploadFile("C:\\Users\\Administrator\\Desktop\\girl3.jpg","girl3.jpg");
